...
const PDF_BASE = `${BAC_BASE}/${MUSCULATION_SLUG}/pdfs`;
const withPdf = (slug: string) => `${PDF_BASE}/${slug}.pdf`;
...
export const BAC_MUSCULATION_DOCS: BacMusculationDoc[] = [
  {
    ...
    pdfPath: withPdf("musculation-au-bac"),
    summaryMd: summary(
  ...
  },
  {
    ...
    pdfPath: withPdf("construire-sa-seance"),
    summaryMd: summary(
  ...
  },
  {
    ...
    pdfPath: withPdf("parametres-3-themes"),
    summaryMd: summary(
  ...
  },
  {
    ...
    pdfPath: withPdf("projet-endurance-de-force"),
    summaryMd: summary(
  ...
  },
  {
    ...
    pdfPath: withPdf("projet-puissance"),
    summaryMd: summary(
  ...
  },
  {
    ...
    pdfPath: withPdf("synthese-methodes"),
    summaryMd: summary(
  ...
  },
  {
    ...
    pdfPath: withPdf("serie-brulante"),
    summaryMd: summary(
  ...
  },
  {
    ...
    pdfPath: withPdf("triple-tri-set"),
    summaryMd: summary(
  ...
  },
  {
    ...
    pdfPath: withPdf("circuit-training"),
    summaryMd: summary(
  ...
  },
  {
    ...
    pdfPath: withPdf("demarche-spiralaire"),
    summaryMd: summary(
  ...
  },
  {
    ...
    pdfPath: withPdf("detente-verticale"),
    summaryMd: summary(
  ...
  },
  {
    ...
    pdfPath: withPdf("vitesse-agilite"),
    summaryMd: summary(
