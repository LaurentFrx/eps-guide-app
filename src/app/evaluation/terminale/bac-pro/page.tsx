...
export default function EvaluationBacProPage() {
  return (
    <div className="space-y-6">
      ...
      <header className="space-y-2">
        ...
        <p className="text-sm text-white/70">
          Référentiel et attendus pour le bac professionnel.
        </p>
      </header>
      ...
      <GlassCard className="space-y-2">
        ...
        <p className="text-sm text-white/70">
          Consolider le projet, sécuriser les réglages et documenter les choix.
        </p>
      </GlassCard>
