    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-4">
        <GlassCard className="space-y-2">
          ...
          <Link href="/evaluation/seconde" className="ui-link text-sm">
            Ouvrir Seconde
          </Link>
        </GlassCard>
        ...
        <GlassCard className="space-y-2">
          ...
          <Link href="/evaluation/premiere" className="ui-link text-sm">
            Ouvrir Première
          </Link>
        </GlassCard>
        ...
        <GlassCard className="space-y-2">
          ...
          <Link href="/evaluation/cap" className="ui-link text-sm">
            Ouvrir CAP
          </Link>
        </GlassCard>
