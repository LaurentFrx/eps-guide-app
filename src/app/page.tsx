    ...
    <div className="space-y-6 pb-8 animate-in fade-in-0 slide-in-from-bottom-3">
      <div className="space-y-4">
        ...
        <div className="flex flex-wrap items-center gap-2">
          <Badge className="border border-border/50 bg-surface/60 text-foreground">
            {sessions.length} sessions
          </Badge>
          <Badge className="border border-accent/80 bg-surface/60 text-foreground">
      ...
      <GlassCard className="space-y-3 border border-border/60 bg-surface/70 shadow-sm">
        ...
        <form action="/search" method="get" className="flex gap-2">
          <div className="relative flex-1">
            ...
            <Input
              ...
              className="pl-9 bg-surface/60 border-border/60 focus-visible:ring-2 focus-visible:ring-ring/40"
            />
          </div>
          <Button type="submit" className="shrink-0 bg-primary text-white hover:bg-primary-2">
            Chercher
          </Button>
        </form>
      </GlassCard>
        ...
        <div className="grid gap-4">
          {sessions.map((session) => (
            <Link key={session.id} href={`/exercises/${session.id}`} className="block">
              <GlassCard className="border border-border/60 bg-surface/70 shadow-sm transition hover:-translate-y-0.5 hover:shadow-lg">
                ...
                <div className="mt-4 flex flex-wrap gap-2">
                  <Badge className="border border-border/60 bg-surface/60 text-foreground">
