...
export function V3Markdown({ text, className }: V3MarkdownProps) {
  if (!text) return null;
  const blocks = toBlocks(text);

  return (
    <div className={cn("space-y-3 text-sm text-[color:var(--v3-text-muted)]", className)}>
